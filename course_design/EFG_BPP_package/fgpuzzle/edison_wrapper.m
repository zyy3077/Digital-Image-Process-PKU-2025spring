...
%cys comment starts to avoid running error by synergistic setting to false
%cys: this is actually a bug of matlab edison wrapper
%     grad = reshape(grad,imsiz([2 1]))';  
%     conf = reshape(conf',imsiz([2 1]))';
%cys comment ends to avoid running error by synergistic setting
end
